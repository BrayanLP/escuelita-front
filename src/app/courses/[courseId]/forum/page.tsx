...
export default function CourseForumPage({ params }: { params: { courseId: string } }) {
            ...
            <Card key={thread.id} className="hover:shadow-md transition-shadow">
              <CardHeader>
                ...
                <CardDescription className="text-xs flex flex-wrap gap-x-3 gap-y-1 items-center">
                  ...
                  <span className="flex items-center gap-1"><Clock className="w-3 h-3" /> Started {formatDistanceToNow(new Date(thread.created_at), { addSuffix: true })}</span>
