...
export default function CourseViewerPage() {
  ...
  const progressPercentage = (() => {
    ...
    const currentIndex = selectedLesson
      ...
      : -1;
    if (currentIndex === -1 && course.lessons.length > 0)
      return (1 / course.lessons.length) * 100; // if no lesson selected, show progress for first
    if (currentIndex !== -1)
      ...
      <aside className="w-full md:w-80 lg:w-96 bg-card md:rounded-lg md:shadow-sm border-b md:border flex flex-col">
        <CardHeader className="p-4 border-b">
          <Button
            variant="ghost"
            size="sm"
            className="mb-2 self-start px-2 text-muted-foreground hover:text-primary"
            asChild
          >
            <Link href="/">
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <CardTitle
              className="text-xl font-headline truncate"
              title={course.title}
            >
              {course.title}
            </CardTitle>
          ...
          <Card className="h-full flex flex-col shadow-lg rounded-lg overflow-hidden">
            ...
            <CardContent className="p-0 flex-grow flex flex-col">
              <div className="aspect-video bg-slate-900 relative group">
                <Image
                  src={
                    selectedLesson.videoPlaceholderImageUrl ||
                  ...
                  objectFit="cover"
                  data-ai-hint={
                    selectedLesson.videoImageHint || "tutorial video screen"
                  }
                />
              ...
              <div className="flex-grow p-4 md:p-6">
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  Further details or transcript for "{selectedLesson.title}"
